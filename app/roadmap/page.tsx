...
const PHASES: Phase[] = [
  {
    ...
    items: [
      ...
      { title: "Multi-provider support", desc: "Connect Railway, Render, Netlify, Fly.io, and Heroku. Monitor all your deployments across providers in one place.", status: "shipped", tag: "✓ Live" },
      { title: "GitHub integration + AI code fix", desc: "Connect your repos. m-ops analyses your code, spots issues, and suggests fixes — powered by AI. One click to open a PR.", status: "shipped", tag: "✓ Live" },
      { title: "AI chat assistant", desc: "Ask anything about your production app. Understands your uptime history, incidents, and deployment state to give context-aware answers.", status: "shipped", tag: "✓ Live" },
      { title: "CMS panel", desc: "Manage your app's content directly from m-ops. No need to open a separate admin panel.", status: "shipped", tag: "✓ Live" },
      { title: "Analytics dashboard", desc: "Pull live stats from your app's admin API — revenue, users, orders, traffic — and see them alongside your uptime data.", status: "shipped", tag: "✓ Live" },
      { title: "Command center", desc: "Keyboard-driven command palette to jump between projects, trigger checks, and run actions without leaving the dashboard.", status: "shipped", tag: "✓ Live" },
      { title: "On-call schedule", desc: "Set who gets paged and when. Rotations, escalations, and contact preferences per team member.", status: "shipped", tag: "✓ Live" },
      { title: "SLA tracking", desc: "Track your uptime SLA per project. See when you're at risk of breaching and get ahead of it.", status: "shipped", tag: "✓ Live" },
